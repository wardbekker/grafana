...
func (e *postgresExecutor) getDSInfo(pluginCtx backend.PluginContext) (*sqleng.DatasourceInfo, error) {
...
func (s *postgresExecutor) generateConnectionString(dsInfo *sqleng.DatasourceInfo) (string, error) {
	var host string
	var port int
